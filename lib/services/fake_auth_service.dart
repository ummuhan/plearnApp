...
class FakeAuthenticationService implements AuthBase {
  ...
  Future<User> currentUser() async {
    ...
    return await Future.value( User(userId: userID, email: null, userID: null));
  }

  @override
  Future<User> signInAnonymously() async {

    return await Future.delayed(Duration(seconds:2),()=>User(userId: userID, email: null, userID: null));
  }
  @override
  Future<bool> signOut() {
