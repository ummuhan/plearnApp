  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        actions: <Widget>[
          ...
          IconButton(
            onPressed: () {
              Share.share(
                  "Have you downloaded our Plearn mobile app?"); //Share kısmı.
            },
            icon: Icon(Icons.share),
            tooltip: "Share",
          ),
          IconButton(
            onPressed: () => _cikisYap(context), //Share kısmı.
                  ...
                  child: ListTile(
                    onTap: () {
                      Navigator.push(
                        ...
                        MaterialPageRoute(
                          builder: (context) =>
                              splashscreen(), //Abstract sınıftır direkt olarak route diyerek sayfayı çağıramayız.
                        ),
                      );
                    },
      ...
      drawer: yanMenu(
        authServise: null,
        onSignOut: null,
      ), //Yanda çıkan bilgilendirme ve diğer sekme kısmını açan widget.
    );
  }
}
