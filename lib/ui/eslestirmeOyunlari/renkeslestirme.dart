...
class RenkEslestirme extends StatefulWidget {
  RenkEslestirme({Key key}) : super(key: key);

  @override
  _RenkEslestirmeState createState() => _RenkEslestirmeState();
}

class _RenkEslestirmeState extends State<RenkEslestirme> {
