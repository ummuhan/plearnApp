...
class YiyecekEslestirme extends StatefulWidget {
  YiyecekEslestirme({Key key}) : super(key: key);

  @override
  _YiyecekEslestirmeState createState() => _YiyecekEslestirmeState();
}

class _YiyecekEslestirmeState extends State<YiyecekEslestirme> {
