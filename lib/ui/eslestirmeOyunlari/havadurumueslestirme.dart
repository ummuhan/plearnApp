...
class HavaDurumuEslestirme extends StatefulWidget {
  HavaDurumuEslestirme({Key key}) : super(key: key);

  @override
  _HavaDurumuEslestirmeState createState() => _HavaDurumuEslestirmeState();
}

class _HavaDurumuEslestirmeState extends State<HavaDurumuEslestirme> {
