...
class MeyveEslestirme extends StatefulWidget {
  MeyveEslestirme({Key key}) : super(key: key);

  @override
  _MeyveEslestirmeState createState() => _MeyveEslestirmeState();
}

class _MeyveEslestirmeState extends State<MeyveEslestirme> {
