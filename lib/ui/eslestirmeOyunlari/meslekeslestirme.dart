...
class MeslekEslestirme extends StatefulWidget {
  MeslekEslestirme({Key key}) : super(key: key);

  @override
  _MeslekEslestirmeState createState() => _MeslekEslestirmeState();
}

class _MeslekEslestirmeState extends State<MeslekEslestirme> {
